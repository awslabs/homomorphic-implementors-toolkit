...
Flags primarily for users:
 - `CMAKE_INSTALL_PREFIX`: Installation target directory for `make install` or `ninja instal`; see https://cmake.org/cmake/help/latest/variable/CMAKE_INSTALL_PREFIX.html.
