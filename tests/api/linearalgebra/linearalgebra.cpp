...
TEST(LinearAlgebraTest, MultiplyMatrixCol) {
    ...
    test_multiply_matrix_col(linear_algebra, unit1_height, large_width, PI, unit1, mixed_unit);
    test_multiply_matrix_col(linear_algebra, large_height, large_width, PI, unit1, mixed_unit);
...
TEST(LinearAlgebraTest, RescaleToNextMatrix) {
    ...
    uint64_t prime = ckks_instance.context->last_prime(ct_mat1.he_level());
...
TEST(LinearAlgebraTest, RescaleToNextRow) {
    ...
    uint64_t prime = ckks_instance.context->last_prime(ct_vec1.he_level());
...
TEST(LinearAlgebraTest, RescaleToNext_Matrix) {
    ...
    ASSERT_EQ(ct_mat1.he_level(), 0);
    uint64_t prime = ckks_instance.context->last_prime(1);
