...
TEST(LinearAlgebraTest, RescaleToNextMatrix) {
    ...
    uint64_t prime = ckks_instance.context->getQi(ct_mat1.he_level());
...
TEST(LinearAlgebraTest, RescaleToNextRow) {
    ...
    uint64_t prime = ckks_instance.context->getQi(ct_vec1.he_level());
...
TEST(LinearAlgebraTest, RescaleToNext_Matrix) {
    ...
    ASSERT_EQ(ct_mat1.he_level(), 0);
    uint64_t prime = ckks_instance.context->getQi(1);
