...
HomomorphicEval::HomomorphicEval(const std::shared_ptr<seal::SEALContext> &c, seal::CKKSEncoder &encoder, seal::Encryptor &encryptor,
                                 const seal::GaloisKeys &gkeys, const seal::RelinKeys &relin_keys, bool verbose):
...
CKKSCiphertext HomomorphicEval::multiply_plain_mat_internal(const CKKSCiphertext &encrypted, const std::vector<double> &plain) {
